...
const CalendarRoundCard: FC<{
  ...
  return (
    ...
    >
      <header className="flex shrink-0 flex-col items-center justify-center gap-0.5 bg-[var(--panel)] px-2 py-1 text-center lg:py-1">
      ...
      <ul className="flex min-h-0 flex-1 flex-col">
        {games.map((game, index) => (
          <li
            ...
            className={`grid min-h-0 flex-1 grid-cols-[2fr_1fr_2fr] items-center gap-x-1 px-1.5 py-px text-[0.5625rem] leading-tight sm:gap-x-1.5 sm:px-2 sm:text-[0.625rem] lg:gap-x-2 lg:px-2 lg:text-[0.6875rem] xl:text-xs ${
